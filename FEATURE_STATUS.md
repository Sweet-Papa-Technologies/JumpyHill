...
| Tire/input | Cylinder rigid body, CCD, rolling torque, lean steering forces, two nudges/cooldown/TILT, mouse/touch/keyboard, four unlockable variants | Device feel sign-off; contact-patch camber model remains simplified |
| Preview | One-second dotted path using Jolt motion queries against real collision geometry | Full cloned rigid-body pre-roll and verified <2 ms budget; full predictor-based nudge-save award |
| Hills | 33 individually addressable metadata/scenes; three sculpted channels, pegs, bumpers, ramps, boosts, mud, rails, static logs, moving final gates; full solver passes | Richer authored lane graphs, actual gap/slow-lane geometry, rotating log feature, integrated edited-heightmap/spline baking |
...
| Presentation | Four palettes and world props, chase/FOV/shake, short view hit-stop, deterministic-trigger slow motion, dust, pooled tread decals, speed blur/lines/vignette, confetti, squash, goal wobble/orbit | Full toon/rim shader system, final sound/animation tuning, animated style tally, coin-like miss finish, per-feature reusable editor scenes |
